...
import SubmitRepositoryForm from './SubmitRepositoryForm';
...
const IdeaDetail: React.FC = () => {
  ...
  const renderAnalysisContent = (analysis: any) => {
    ...
    // MVP Features
    if (
      analysisType === 'mvp-core-features' ||
      analysis.title?.includes('MVP') ||
      analysis.title?.includes('Features')
    ) {
    ...
    if (
      ...
      analysis.title?.includes('Action') ||
      analysis.title?.includes('Steps')
    ) {
    ...
    if (
      ...
      analysis.title?.includes('Competitive')
    ) {
    ...
    if (
      analysisType === 'monetization-strategy' ||
      analysis.title?.includes('Monetization')
    ) {
    ...
    // Technical Stack
    if (
      analysisType === 'technical-stack' ||
      analysis.title?.includes('Tech') ||
      analysis.title?.includes('Stack')
    ) {
    ...
    // Metrics & KPIs
    if (
      analysisType === 'success-metrics' ||
      analysis.title?.includes('Metrics') ||
      analysis.title?.includes('KPI')
    ) {
    ...
    // Risks & Mitigations
    if (
      analysisType === 'risks-mitigations' ||
      analysis.title?.includes('Risk')
    ) {
    ...
    if (
      analysisType === 'opportunity-analysis' ||
      analysis.title?.includes('Opportunity')
    ) {
                ...
                return (
                  <div
                    ...
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <span
                        className={`text-xs px-2 py-1 rounded-full ${threatColor}`}>
                        {competitor.threat}
                      </span>
                    </div>
              ...
              {pricingTiers.map((tier: any, index: number) => {
                ...
                return (
                  <div
                    ...
                    <h5 className="font-medium text-gray-900 text-center mb-2">
                      {tier.name}
                    </h5>
                    ...
                    <ul className="space-y-2">
                      {Array.isArray(tier.keyFeatures) ? (
                        tier.keyFeatures.map((feature: string, i: number) => (
  ...
  const renderTechStack = (payload: any) => {
    ...
    return (
      <div className="space-y-6">
        ...
        {implementationComplexity && (
          <div
            ...
            <p
              ...
              {implementationComplexity === 'high'
                ? 'This solution requires significant development resources and expertise.'
                : implementationComplexity === 'medium'
                ? 'This solution requires moderate development effort with some technical expertise.'
        ...
        {coreComponents.length === 0 &&
          (!workflow.steps || workflow.steps.length === 0) &&
          idea?.repository?.languages && (
            <div>
              <h4 className="font-medium text-gray-900 mb-3">
                Repository Languages
              </h4>
              <div className="flex flex-wrap gap-2">
                {Object.keys(idea.repository.languages).map(
                  (language, index) => (
                    <span
                      key={index}
              ...
              return (
                <div key={index} className={`border ${color} rounded-lg p-4`}>
                  <div className="flex items-start justify-between mb-2">
                    ...
                    {metric.importance && (
                      <span
                        className={`text-xs px-2 py-1 rounded-full ${importanceColor}`}>
                        {metric.importance}
                      </span>
                    )}
                  </div>
      ...
      <div className="space-y-6">
                  ...
                  <div
                    ...
                    {(impact || probability) && (
                      <div className="flex flex-wrap gap-2 mb-3">
                        {impact && (
                          <span
                            className={`text-xs px-2 py-1 rounded-full ${impactColor}`}>
                            Impact: {impact}
                          </span>
                        )}
                        {probability && (
                          <span
                            className={`text-xs px-2 py-1 rounded-full ${probColor}`}>
        ...
        {!risks.length && !criticalRisks.length && !contingencyPlans.length && (
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-center">
            <HelpCircle className="h-8 w-8 text-gray-400 mx-auto mb-2" />
            <p className="text-gray-600">
              No specific risks identified for this idea yet.
            </p>
          </div>
        )}
      </div>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <div className="text-center mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
              <div
                className={`bg-white rounded-lg p-4 shadow-sm border ${getScoreBgColor(
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
            ...
            <div>
              ...
              {analysisData.market && analysisData.market.length > 0 ? (
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    No detailed market analysis available for this idea yet.
                  </p>
                </div>
              )}
            </div>
            ...
            <div>
              ...
              {analysisData.features && analysisData.features.length > 0 ? (
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-center">
                  <HelpCircle className="h-10 w-10 text-gray-400 mx-auto mb-3" />
                  <p className="text-gray-600">
                    No feature analysis available for this idea yet.
                  </p>
                </div>
              )}
            </div>
            ...
            <div>
              ...
              {analysisData.tech && analysisData.tech.length > 0 ? (
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    No technical stack analysis available for this idea yet.
                  </p>

                  {/* Show repository languages if available */}
                  {idea.repository?.languages &&
                    Object.keys(idea.repository.languages).length > 0 && (
                      <div className="mt-6">
          ...
          {activeTab === 'monetization' && (
            <div>
              ...
              {analysisData.monetization &&
              analysisData.monetization.length > 0 ? (
                <div>
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    No monetization strategy available for this idea yet.
                  </p>
                </div>
              )}
            </div>
          ...
          {activeTab === 'competitive' && (
            <div>
              ...
              {analysisData.competitive &&
              analysisData.competitive.length > 0 ? (
                <div>
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    No competitive analysis available for this idea yet.
                  </p>
                </div>
              )}
            </div>
            ...
            <div>
              ...
              {analysisData.risks && analysisData.risks.length > 0 ? (
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    No risk analysis available for this idea yet.
                  </p>
                </div>
              )}
            </div>
            ...
            <div>
              ...
              {analysisData.action && analysisData.action.length > 0 ? (
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    No action items available for this idea yet.
                  </p>
                </div>
              )}
            </div>
            ...
            <div>
              ...
              {analysisData.metrics && analysisData.metrics.length > 0 ? (
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    No metrics analysis available for this idea yet.
                  </p>
                </div>
              )}
            </div>
            ...
            <div>
              ...
              {analysisData.gtm && analysisData.gtm.length > 0 ? (
                ...
                <div className="bg-gray-50 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600">
                    No go-to-market strategy available for this idea yet.
                  </p>
                </div>
              )}
            </div>
