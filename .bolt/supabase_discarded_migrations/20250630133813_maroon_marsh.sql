/*
  ...
  1. Changes Made
    - Insert sample data into categories table with realistic values
    - Includes descriptions, growth rates, business scores, and market sizes
    - Uses ON CONFLICT to update existing categories with new data

  2. Purpose
    - Provide meaningful data for the categories UI
    - Ensure growth rates and business scores are populated
    - Support filtering and sorting in the categories page
*/
